...
LOTUS_WEIGHTS_PATH = os.path.join(ROOT_DIR, "weights/mask_rcnn_multi_lotus.h5")
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        #self.add_class("lotus", 1, "BG")
        self.add_class("lotus", 1, "pistil")
        self.add_class("lotus", 2, "petales")
        self.add_class("lotus", 3, "personnage")
        self.add_class("lotus", 4, "medaillon")
        ...
        for a in annotations:
            ...
            objects = [s['region_attributes']['lotus'] for s in a['regions']]
            print("objects:",objects)
            #name_dict = {"bg": 1,"lotus": 2}
            name_dict = {"pistil": 1, "petales": 2, "personnage": 3, "medaillon": 4}
            # key = tuple(name_dict)
            ...
            self.add_image(
                "lotus",  ## for a single class just add the name here
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        if image_info["source"] != "lotus":
            return super(self.__class__, self).load_mask(image_id)

        # Convert polygons to a bitmap mask of shape
        # [height, width, instance_count]
        info = self.image_info[image_id]
        if info["source"] != "lotus":
            return super(self.__class__, self).load_mask(image_id)
...
if __name__ == '__main__':
    ...
    # Create model
    if args.command == "train":
        model = modellib.MaskRCNN(mode="training", config=CustomConfig(),
                                  model_dir=args.logs)
    else:
    ...
    elif args.weights.lower() == "lotus":
        # Use lotus trained weights
        weights_path = LOTUS_WEIGHTS_PATH
    else:
